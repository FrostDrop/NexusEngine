...
namespace Nexus
{
	...
	void* FMemory::Memset(void* Dest, uint8 Char, PlatformSizeType Size)
	{
		return FPlatformMemory::Memset(Dest, Char, Size);
	}

	void* FMemory::Memzero(void* Dest, PlatformSizeType Size)
	{
		return FPlatformMemory::Memzero(Dest, Size);
	}
